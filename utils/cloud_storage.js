...
const storage = new Storage({
  projectId: "deliveryappmysql-c2062", // Ambos parámetros vienen de la configuración del proyecto en firebase
  keyFilename: "./serviceAccountKey.json", // Este archivo hace enlace con firebase
});

const bucket = storage.bucket("gs://deliveryappmysql-c2062.appspot.com/");
